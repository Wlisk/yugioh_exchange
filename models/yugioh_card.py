...
class Offer(SQLModel, table=True):
  ...
  cards_given: list[YugiohCard] = Relationship(sa_relationship_kwargs=dict(lazy="selectin"), link_model=OfferCardsGiven)
  cards_wants: list[YugiohCard] = Relationship(sa_relationship_kwargs=dict(lazy="selectin"), link_model=OfferCardsWants)
